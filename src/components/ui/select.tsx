  ...
  return (
    <div className="relative w-full">
      <Listbox value={value} onChange={onChange}>
        <Listbox.Button className="flex items-center justify-between w-full px-4 py-2 border border-gray-300 rounded-md bg-white shadow-sm text-left text-sm">
          {value
...
// Dummy placeholder to prevent errors where SelectItem is imported
